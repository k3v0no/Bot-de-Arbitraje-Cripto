...
Bot-de-Arbitraje-Cripto/
├── backend/
│   └── src/
│       ├── configuracion.js       # Fees, slippage y parámetros de riesgo
│       ├── server.js              # Express + loop del bot
│       ├── bot.js                 # Orquestador del ciclo de análisis
│       ├── exchanges/
│       │   ├── index.js           # Promise.allSettled de todos los exchanges
│       │   ├── binance.js         # WebSocket + fallback REST
│       │   ├── kraken.js          # REST con normalización
│       │   └── ccxt.js            # Adaptador universal para 6 exchanges
│       ├── arbitraje/
│       │   ├── motor.js           # Evaluación de N×(N-1) pares
│       │   └── calculadora.js     # Fórmula de ganancia neta
│       └── state/
│           └── almacen.js         # Estado en memoria (precios, balances, historial)
└── frontend/
└── src/
├── App.jsx                # Routing de pestañas y polling al backend
└── pages/
├── Dashboard.jsx      # P&L, métricas y oportunidad actual
├── MercadoEnVivo.jsx  # Precios, mapa de calor y balances
└── Historial.jsx      # Trades ejecutados y descartes
---
...
| Servicio | URL |
|---|---|
| Frontend (Vercel) | https://bot-de-arbitraje-cripto.vercel.app/ |
| Backend (Railway) | https://bot-de-arbitraje-cripto-production.up.railway.app/ |
